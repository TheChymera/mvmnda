ExpKeys.subject = "M483";
ExpKeys.DOB = "2023-06-19";
ExpKeys.species =  "mouse";
ExpKeys.genetics = "Ai-27";
ExpKeys.sex = "Male";
ExpKeys.probeDepth = 4; % in mm
ExpKeys.experimenter = "Kyoko";
ExpKeys.hemisphere =  "Left";
ExpKeys.date = "2024-01-22"; 
ExpKeys.insertion_AP = -2; % in mm, relative to bregma
ExpKeys.insertion_ML = -1.5; % in mm, relative to bregma %left is minus
