...
ExpKeys.probe1_Depth = 4.24; % in mm;
...
ExpKeys.notes = "Random odors (1-1.5s on, 2.5-3.5s neutral on, jittered timings), data recorded with tip reference and AP gain 3000";
