...
ExpKeys.probe1_Depth = 4.1; % in mm;
ExpKeys.probe1_hemisphere = "Right";
ExpKeys.probe1_insertion_AP = -2.2; % in mm, relative to bregma, posterior is minus
ExpKeys.probe1_insertion_ML = -2.5; % in mm, relative to bregma, left is plus, right is minus
