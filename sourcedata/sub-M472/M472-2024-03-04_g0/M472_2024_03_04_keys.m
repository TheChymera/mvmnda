ExpKeys.subject = "M472";
ExpKeys.DOB = "2023-05-14";
ExpKeys.species =  "mouse";
ExpKeys.genetics = "C57BL(6J)/WT";
ExpKeys.sex = "Female";
ExpKeys.experimenter = "Manish";
ExpKeys.date = "2024-03-04"; 

ExpKeys.probe1_ID = "imec0";
ExpKeys.probe1_Depth = 6.6; % in mm;
ExpKeys.probe1_hemisphere = "Right";
ExpKeys.probe1_insertion_AP = -3.1; % in mm, relative to bregma, posterior is minus
ExpKeys.probe1_insertion_ML = -1.2; % in mm, relative to bregma, left is plus, right is minus
ExpKeys.probe1_insertion_pitch = 90; % pinpoint convention
ExpKeys.probe1_insertion_yaw = 0; % pinpoint convention
ExpKeys.probe1_insertion_roll = 42; % pinpoint convention
...
ExpKeys.notes = "Random odors (1-1.5s on, 2.5-3.5s neutral on, jittered timings), " + ...
    "data recorded with external reference and AP gain 500, used headstage cable connected to Port 3";
