...
ExpKeys.probe1_Depth = 6.3; % in mm;
ExpKeys.probe1_hemisphere = "Right";
ExpKeys.probe1_insertion_AP = -3.1; % in mm, relative to bregma, posterior is minus
ExpKeys.probe1_insertion_ML = -0.4; % in mm, relative to bregma, left is plus, right is minus
...
ExpKeys.notes = "Random odors (1-1.5s on, 2.5-3.5s neutral on, jittered timings), some saturation in signal";
